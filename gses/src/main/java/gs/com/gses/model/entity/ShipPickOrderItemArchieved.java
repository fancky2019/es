...
public class ShipPickOrderItemArchieved implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        ShipPickOrderItemArchieved other = (ShipPickOrderItemArchieved) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getShippickorderarchievedid() == null ? other.getShippickorderarchievedid() == null : this.getShippickorderarchievedid().equals(other.getShippickorderarchievedid()))
            && (this.getShiporderitemarchievedid() == null ? other.getShiporderitemarchievedid() == null : this.getShiporderitemarchievedid().equals(other.getShiporderitemarchievedid()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getShippickorderarchievedid() == null) ? 0 : getShippickorderarchievedid().hashCode());
        result = prime * result + ((getShiporderitemarchievedid() == null) ? 0 : getShiporderitemarchievedid().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", shippickorderarchievedid=").append(shippickorderarchievedid);
        sb.append(", shiporderitemarchievedid=").append(shiporderitemarchievedid);
