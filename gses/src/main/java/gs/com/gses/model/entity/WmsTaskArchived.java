...
public class WmsTaskArchived implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        WmsTaskArchived other = (WmsTaskArchived) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getWorkorderarchivedid() == null ? other.getWorkorderarchivedid() == null : this.getWorkorderarchivedid().equals(other.getWorkorderarchivedid()))
            ...
            && (this.getOldcreationtime() == null ? other.getOldcreationtime() == null : this.getOldcreationtime().equals(other.getOldcreationtime()))
            && (this.getOldlastmodificationtime() == null ? other.getOldlastmodificationtime() == null : this.getOldlastmodificationtime().equals(other.getOldlastmodificationtime()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getWorkorderarchivedid() == null) ? 0 : getWorkorderarchivedid().hashCode());
        ...
        result = prime * result + ((getOldcreationtime() == null) ? 0 : getOldcreationtime().hashCode());
        result = prime * result + ((getOldlastmodificationtime() == null) ? 0 : getOldlastmodificationtime().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", workorderarchivedid=").append(workorderarchivedid);
        ...
        sb.append(", oldcreationtime=").append(oldcreationtime);
        sb.append(", oldlastmodificationtime=").append(oldlastmodificationtime);
